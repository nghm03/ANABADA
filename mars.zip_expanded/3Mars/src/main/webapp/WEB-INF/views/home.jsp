...
<div id='wrapper'>
	...
	<div class="container">
		<div class="first">
			<div class="text">
				<h1 style="font-size: 40px; margin-top: 10px; margin-bottom: 10px;">Welcome to Our ANABADA</h1>
				<p>Numerous memories and stories gather every day.</p>
				<p>These items are all things that someone willingly offered for someone else with a good heart.</p>
				<p>Donations are now made by someone else meeting a new owner and making new memories.</p>
				<p>It is the moment when a new relationship is created between people. </p>
				<p>So all donations collected in Anabada are precious, no matter how small they are.</p>
			</div>
			<img src="${pageContext.request.contextPath}/resources/img2/c.jpg">
		</div>
		<!-- 메인 상품들 -->
		<div class="main_text">
			<p>Our Product</p>
		...
		<div class="product">
			<div class="button">
				<a href="kategorieProcess?pc=0">SHOP NOW →</a>
			</div>
			<ul>
				<c:forEach var="ProductVO" items="${pvl }">
                    <c:if test="${ProductVO.product_stock == 1 }">
                        <li><a href="buy?p=${ProductVO.product_num }"><div class="duct"><img src="${ProductVO.product_image }"/><div class="details"><p style="font-size: 14px;">${ProductVO.product_name }</p><p><b>${ProductVO.product_price } ANA</b></p></div></a></li>
                    </c:if>
                </c:forEach>
			</ul>
		</div>
